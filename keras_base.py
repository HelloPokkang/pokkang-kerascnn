...
train_generator = train_datagen.flow_from_directory(folder+'base/train',
                                                    target_size=(200, 400),
...
validation_generator = test_datagen.flow_from_directory(folder+'base/test',
                                                        target_size=(200, 400),
                                                        class_mode='categorical')



model_name = "keras_base_2.h5"
model.fit_generator(
    train_generator,
